...
class EqualityTest(unittest.TestCase):
    ...
    def testConnection(self):
        try:
            ...
            self.fail(
                "makeConnection() raised an error and could not connect to the database"
            )
    ...
    def testRead(self):
        try:
            ...
            self.fail(
                "readFromTable() rasied an error and could not read from the dojos table"
            )
    ...
    def testInsert(self):
        try:
            ...
            self.fail(
                "insertRow() rasied an error and could not insert to the dojos table"
            )
